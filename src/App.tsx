...
const Logos = {
  HTML: (
    ...
    >
      ...
      <path
        fill="#EBEBEB"
        d="M64 52H44l1 12h19V52zm0-24H43l1 12h20V28zm0 54l-.1.03L51 79l-1-10H38l2 24 24 7 .1-.03V82z"
      />
      <path
        fill="#FFF"
        d="M64 52v12h18l-2 15-16 4v12l24-7 3-36H64zm0-24v12h22l1-12H64z"
      />
    </svg>
  ),
  CSS: (
    ...
    >
      ...
      <path
        fill="#FFF"
        d="M64 64v12h18l-2 15-16 4v12l24-7 3-36H64zm0-36v12h22l1-12H64z"
      />
    </svg>
  ),
  JS: (
  ...
  Next: (
    ...
    >
      ...
      />
      <path
        d="M98 80h60M98 128h60M98 176h60"
        stroke="#000"
        strokeWidth="14"
        strokeLinecap="round"
      />
  ...
  Tailwind: (
    ...
    >
      <path
        d="M64 128c16-48 56-72 88-40 8 8 12 16 12 24-16-24-40-24-56-8-8 8-12 16-16 24-16 48-56 72-88 40 16 24 40 24 60 10 8-6 14-14 20-26z"
        fill="#000"
      />
    </svg>
  ),
  ...
  return (
    <Box
      ...
      sx={{
        ...
        bgcolor: "#FFC107",
        color:
          theme.palette.getContrastText("#FFC107") === "#000" ? "#000" : "#000",
        // Border + shadow
        border: "2px solid rgba(0,0,0,0.35)",
        boxShadow: "3px 3px 0 rgba(0,0,0,0.45), 0 10px 24px rgba(0,0,0,0.10)",
        ...
        "&:hover": {
          ...
          boxShadow: "6px 6px 0 rgba(0,0,0,0.45), 0 18px 36px rgba(0,0,0,0.16)",
          bgcolor: "#FFCA28",
        },
        "&:focus-visible": {
      ...
      onKeyDown={(e) => {
        if (
          (e.key === "Enter" || e.key === " ") &&
          (skill.onClick || skill.href)
        ) {
          e.preventDefault();
          if (skill.onClick) skill.onClick();
          if (skill.href)
            window.open(skill.href, "_blank", "noopener,noreferrer");
        }
      }}
      onMouseUp={() => {
        if (skill.href)
